...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-votre-cle-secrete-ici-modifiez-pour-la-production')
...
ALLOWED_HOSTS = config(
    'ALLOWED_HOSTS',
    default='sicmisarl.com,www.sicmisarl.com,.onrender.com,localhost,127.0.0.1',
    cast=lambda v: [s.strip() for s in v.split(',')]
)

CSRF_TRUSTED_ORIGINS = config(
    'CSRF_TRUSTED_ORIGINS',
    default='https://sicmisarl.com,https://www.sicmisarl.com,https://*.onrender.com',
    cast=lambda v: [s.strip() for s in v.split(',')]
)
...
MIDDLEWARE = [
    ...
    'django.middleware.gzip.GZipMiddleware',  # Compressione GZIP
    'django.contrib.sessions.middleware.SessionMiddleware',
    # LocaleMiddleware removed to keep site only in French
...
WSGI_APPLICATION = 'sicmi_site.wsgi.application'
...
if CLOUDINARY_STORAGE['CLOUD_NAME'] and CLOUDINARY_STORAGE['API_KEY'] and CLOUDINARY_STORAGE['API_SECRET']:
    ...
    import warnings
    warnings.warn("Cloudinary credentials not found. Media uploads will not work.")
